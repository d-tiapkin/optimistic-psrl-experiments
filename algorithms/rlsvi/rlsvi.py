...
class RLSVIAgent(AgentWithSimplePolicy):
    ...
    scale_std_noise * sqrt(V_max^2/(4n)) as for Hoeffding bonuses.
    Parameters
    ----------
    env : gym.Env
    ...
    scale_std_noise : double, delfault: 1.0
        ...
        scale_std_noise*sqrt(V_max^2/(4n))+(H-h+1)/n
    ...
    def reset(self, **kwargs):
        ...
        # stds prior
        self.std_sa = self.scale_std_noise * np.ones((H, S, A))
        # visit counter
        ...
        for hh in range(self.horizon):
            self.std_sa[hh, :, :] *= self.v_max[hh] / 2.0
    ...
    def _run_episode(self):
        ...
        std_sa = self.std_sa / np.sqrt(self.N_sa)
